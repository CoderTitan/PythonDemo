...
# 删除目录
# os.rmdir('jun')
# os.rmdir(r'/Users/quanjunt/Documents/Quanjun/GitHub/PythonDemo/PythonStudy/6-模块练习/titan/1.txt')
...
# 判断目录是否存在
path3 = r'/Users/quanjunt/Documents/Quanjun/GitHub/PythonDemo/PythonStudy/6-模块练习'
...
print("当前文件夹: ", os.curdir)
print("上一层级文件夹:", os.pardir)